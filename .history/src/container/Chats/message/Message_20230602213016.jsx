        ...
        messages?.messages?.map(({ message, id, side }) => {
          ...
          return (
            <div
              ...
              // {clsx(
              //   "d-flex justify-content-end",
              //   !side && "d-flex justify-content-start"
              // )}
            >
              <div
                id="chat1"
                className={
                  side ? "p-3 mb-4 style bg-primary" : "bg-white text-muted"
                }
                // {clsx(
                //   "p-3 mb-4 style bg-primary",
                //   !side && "bg-white text-muted justify-content-start d-flex"
                // )}
                style={{
                  // background: "orange",
                  width: "fit-content",
              ...
              >
                <p className="fs-5 small mb-0 text-break">{message}</p>
              </div>
            </div>
          );
        })
