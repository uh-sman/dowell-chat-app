...
const ReplyChat = () => {
  ...
  return (
    <div className="text-black mt-5 d-flex justify-content-end">
      <div className="card py-2 ms-2 w-100 mb-5 " style={{ height: "100%" }}>
...

{
  ...
  <div className="card py-2 ms-2 w-100 " style={{ height: "100%" }}>
    <div className="card-body p-1 " onSubmit={handleSubmit}>
