...
const Message = ({ message }) => {
  ...
  return (
    <div className="container" style={{ chatStyle, background: "grey" }}>
      <section className="" style={{ chatStyle, background: "yellow" }}>
        <div className="container" style={{ chatStyle, background: "green" }}>
          <div
            ...
            style={{ display, justifyContent, background: "blue" }}
          >
            <div
              className="col-6"
