...
const ReplyChat = () => {
  ...
  const [messagingRoom, setMessagingRoom] = useState("");
  // const [messages, setMessages] = useState();
  const handleSubmit = (e) => {
    e.preventDefault();
    setData(input);
    setMessagingRoom(room_Id);
    console.log("messagingRoom: ", messagingRoom);
    ...
    const data = {
      // message: "input",
      message: input,
      user_id: "63f3174a44719d743f21310e",
      message_type: "text/Image",
      org_id: "63f3173b44719d743f213102",
    };

    axios
      .post(
        `https://100096.pythonanywhere.com/send_message/${messagingRoom}/`,
        {
          data,
        }
      )
