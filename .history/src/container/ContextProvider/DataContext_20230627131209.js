  ...
  useEffect(() => {
    const createRooms = async () => {
      const res = await axios.get(
        `https://100096.pythonanywhere.com/create-portfolio/?session_id=efx2oih1p3os849nipth2e5uihzswsfp`
      );
      console.log("createRoom response", res, res.statusText("successful"));
    };
    createRooms();
  }, []);
